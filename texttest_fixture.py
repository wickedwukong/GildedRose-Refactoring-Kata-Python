...
def main():
    ...
    items = [
        ...
        GildedRoseItem.make_item(name="Backstage passes to a TAFKAL80ETC concert", sell_in=15, quality=20),
        GildedRoseItem.make_item(name="Backstage passes to a TAFKAL80ETC concert", sell_in=10, quality=49),
        GildedRoseItem.make_item(name="Backstage passes to a TAFKAL80ETC concert", sell_in=5, quality=49),
